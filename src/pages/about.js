...
const AboutPage = {
    ...
    <div class="grid grid-clo-4 grid-flow-col gap-4 mt-2 mb-2 ">
     <div class="border-2 py-1 px-1 content-center ">
        ...
        <h2 class="mt-2 text-center text-red-700 text-base font-extrabold">Vinh danh 295 sinh viên FPT Polytechinc học kỳ Sping 2018</h2>
      ...
      <div class="border-2 py-1 px-1 content-center ">
        <img class="m-auto h-60" src="https://caodang.fpt.edu.vn/wp-content/uploads/z2588643102739_9864bbfeb92a342eec8497fc81f87d85.jpg" alt="">
        <h2 class="mt-2 text-center text-red-700 text-base font-extrabold">Vinh danh 295 sinh viên FPT Polytechinc học kỳ Sping 2018</h2>
        <p class="mt-1">Tối ngày 16/06/2018 , Cao đẳng FPT Polytechnic Hà Nội đã tổ chức Lễ tôn vinh "Ông vàng Poly",Tuyên dương 295 cá nhan tập thể có thành tích xuất sác trong học tập cũng như hoạt</p>
      </div>
      <div class="border-2 py-1 px-1 content-center ">
        <img class="m-auto  h-60" src="https://caodang.fpt.edu.vn/wp-content/uploads/becc5f81958e73d02a9f-500x333.jpg" alt="">
        <h2 class="mt-2 text-center text-red-700 text-base font-extrabold">Vinh danh 295 sinh viên FPT Polytechinc học kỳ Sping 2018</h2>
        <p class="mt-1">Tối ngày 16/06/2018 , Cao đẳng FPT Polytechnic Hà Nội đã tổ chức Lễ tôn vinh "Ông vàng Poly",Tuyên dương 295 cá nhan tập thể có thành tích xuất sác trong học tập cũng như hoạt</p>
      </div>
    </div>
